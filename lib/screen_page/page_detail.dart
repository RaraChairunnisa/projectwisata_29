...
import 'package:project15_wisatacrud/screen_page/page_maps.dart';
          ...
          children: [
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: wisata.gambar.isNotEmpty
                          ? NetworkImage(
                        'http://172.20.10.7/wisataDB/gambar/${wisata.gambar}',
                      )
            ...
            Center(
              child: ElevatedButton.icon(
                icon: Icon(FontAwesomeIcons.mapLocationDot, color: Colors.blueAccent),
                label: Text('Buka Maps', style: TextStyle(color: Colors.blueAccent)),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Icon(FontAwesomeIcons.infoCircle, color: Colors.blueAccent, size: 18),
                SizedBox(width: 10),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Icon(FontAwesomeIcons.locationCrosshairs, color: Colors.blueAccent, size: 18),
                SizedBox(width: 10),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
